...
const CASE_STUDIES = [
  ...
  },
  {
    ...
    role: "Product Owner de la data platform servant 500+ analystes.",
    actions: [
      "Définition de la vision produit avec les métiers",
      "Backlog de 200+ stories priorisées",
      "Animation de 3 feature teams (15 personnes)",
      "Mise en place de métriques d'adoption",
    ],
    results: [
      "Livraison de 8 data products en 12 mois",
      "Adoption passée de 20% à 75%",
      "Satisfaction utilisateurs : 4.2/5",
    ],
  },
  {
    sector: "Retail",
    title: "Data Manager Gouvernance",
    context: "Un retailer omnicanal avait des données clients incohérentes entre les canaux, impactant le marketing.",
    role: "Data Manager en charge de la qualité et gouvernance des données clients.",
    actions: [
      "Cartographie de 45 sources de données clients",
      "Définition du Golden Record client",
      "Mise en place d'un Data Quality Framework",
      "Formation de 8 Data Owners métiers",
    ],
    results: [
      "Qualité des données clients de 60% à 95%",
      "Réconciliation de 2M de profils dupliqués",
      "Amélioration de 30% des campagnes marketing",
    ],
  },
  {
    sector: "Industrie",
    title: "Chef de Projet Data Analytics",
    context: "Un industriel lançait son programme Data & IA avec 5 use cases simultanés et des équipes dispersées.",
    role: "Chef de projet coordonnant 5 squads data analytics.",
    actions: [
      "Setup des rituels agiles cross-équipes",
      "Coordination de 25 personnes (internes + prestataires)",
      "Gestion du budget programme (1.5M€)",
      "Reporting COPIL mensuel",
    ],
    results: [
      "5 use cases livrés dans les temps et budget",
      "Économies de 800K€ identifiées par les analytics",
      "Méthodo agile pérennisée dans l'organisation",
    ],
  },
] as const;
